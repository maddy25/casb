...
CREATE TABLE incident (
    ...
    status         ENUM('NEW', 'IN_PROGRESS', 'DISMISSED', 'RESOLVED'),
...
- Field Id used inside the rule depends upon service Category
- Actions of a rule depends upon rule enforcement point



Security Provider (SonicWALL)
  Customer1 (Walmart)
    Managed Platform 1 (Office 365)
      Managed Service 1 (Outlook)
      Managed Service 2 (OneDrive)
    Managed Platform 2 (DropBox)
  Customer2 (Safeway)
    Managed Platform 1 (G Suite)
    Managed Platform 2 (DropBox)
*/
